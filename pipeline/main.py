from ._preprocess import prepare_image_detection, prepare_image_segmentation, map_channels
...
if do_segmentation and not is_time_stack:
    im_seg = prepare_image_segmentation(map, image_raw)
...
images_gen = prepare_image_detection(map, image_raw, is_3D_stack=is_3D_stack, multichannel=multichannel, is_time_stack=is_time_stack)

...
class pipeline_parameters(TypedDict) :
            ...
            """
            is_3D_stack : bool # '3D stack'
            alpha : float
            beta : float
            channel_to_compute : int # 'channel to compute'
            do_cluster_computation : bool #'Cluster computation'
            do_dense_regions_deconvolution : bool #'Dense regions deconvolution'
            do_spots_excel : bool
